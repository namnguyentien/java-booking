package com.hotel.booking.utils.export;
...
public class UserExcelExporter {
    ...
    public UserExcelExporter(List<Customer> listUsers) {
    ...
    private void writeHeaderLine() {
        ...
        createCell(row, 3, "Số tiền đã dùng", style);
        createCell(row, 4, "Tạo lúc", style);
    ...
    private void writeDataLines() {
        ...
        for (Customer user : listUsers) {
            ...
            createCell(row, columnCount++, user.getTotalPrice() > 0? user.getTotalPrice()+""  : "0", style);
